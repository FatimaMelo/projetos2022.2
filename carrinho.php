                        ...
                        $sub = 0;
                          ...
                          ?>    
                            ...
                            <tr>
                                ...
                                <td>Transporte</td>
                                <td></td>
                                <td class="text-right"><?php $trans = "Grátis"; echo $trans;?></td>
                            </tr>
                            <tr>
                                <td></td>
                                <td></td>
                                ...
                                <td></td>
                                <td class="text-right"><strong>R$<?php $total = $sub; echo $total;?></strong></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class="col mb-2">
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6 text-right">
                        ...
                        <a onclick="comp()" href="php/comprado.php?id=<?php echo $_SESSION["idconta"];?>" class="btn btn-lg btn-block btn-success text-uppercase">Comprar </a>
